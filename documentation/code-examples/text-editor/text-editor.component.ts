...
@Component({
  selector: 'editor',
  template: require('./views/text-editor.html')
})

export class TextEditorComponent implements OnInit {
  
  public keyUp: Observable<MouseEvent>;
  public click: Observable<MouseEvent>;
  public keyDown: Observable<MouseEvent>;
  ...
  private isSuportedCharacter(keyCode): boolean {
  ...
  private getCharacterFromElement(e: Event, operation: string): {operation: string,
    character: Character, element: Event} {
